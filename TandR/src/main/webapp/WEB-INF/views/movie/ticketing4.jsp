...
<div class="reserve-container">
        ...
        <div class="day-part">
        	...
        	<button class="day-button" id="day-button${val.showingDay }" value="${val.showingDay }" onclick="location.href='ticketing4.mv?movieCode=${movie.movieCode}&theaterCode=${theater.theaterCode }&showingDay=${val.showingDay }'">${val.showingDay }</button>
        	</div>        	
        	</c:forEach>        	
        </div>        
        <div class="time-part">
        ...
        <div class="reserve-where">${screen.screenNum }관</div>
            ...
            <c:if test="${val.screenNum eq screen.screenNum}">
             <button class="reserve-time-button" onclick="location.href='ticketing5.mv?movieCode=${movie.movieCode}&theaterCode=${theater.theaterCode }&screenCode=${val.screenCode }&rsCode=0&screenTime=${val.screenTime }&showingDay=${showingDay}&screenNum=${screen.screenNum }'">
