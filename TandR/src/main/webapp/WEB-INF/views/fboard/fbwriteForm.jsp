...
$(window).load(function(){
	oEditors.getById["fbContent"].exec("UPDATE_CONTENTS_FIELD", [saveboard.fbContent]);
});
...
<body>
	...
	<section>
		<div id="maincontent">
			<a id="title1">| 자유게시판</a> <a id="title2">| 게시글 작성</a>
			<div id="write_container" align="center">
				<div class="tb_frm">
				
					<form action="fboardWrite.fb" name="fwrite" id="fwrite"
						method="post" onsubmit="return chk()"
						enctype="multipart/form-data">
						<input type="hidden" name="fbNum" value="${fbNum}"> <input
							...
							<tbody>
								<tr>
									...
									<td><input type="text" name="fbTitle"
										autofocus="autofocus" size="50" maxlength="255" required="required" value="${saveboard.fbTitle }"></td>
								</tr>
								<tr>
									<th>작성자</th>
									<td>${id }</td>
								...
								<tr>
									<td class="contentArea" colspan="2"><textarea rows="24"
											cols="100" id="fbContent" name="fbContent">${saveboard.fbContent }</textarea></td>
								</tr>
							</tbody>
						</table>
						...
						<div class="btn_confirm2">
							...
							<input type="submit" value="임시 저장" onclick="return chk()" formaction="savefbtemp.fb">
						</div>					
					</form>
